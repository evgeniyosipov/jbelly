...
INSERT IGNORE INTO articles(id, title, entry, content, author_id, category_id)VALUES(1, "TEST_TITLE_1", "TEST_ENTRY_1", "TEST_CONTENT_1", 2, 1);
INSERT IGNORE INTO articles(id, title, entry, content, author_id, category_id)VALUES(2, "TEST_TITLE_2", "TEST_ENTRY_2", "TEST_CONTENT_2", 2, 2);
INSERT IGNORE INTO articles(id, title, entry, content, author_id, category_id)VALUES(3, "TEST_TITLE_3", "TEST_ENTRY_3", "TEST_CONTENT_3", 2, 3);
